...
cfmat$overall[1]
```
We thus have 99% accuracy, with sensitivity and specificity of the same order of magnitude. The out of sample OOB error rate is around 1%. Our prediction for the validation data set are then
```{r}
predict(mdl, valid)
```
